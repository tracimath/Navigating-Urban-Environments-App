...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ARCL",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4ARCL12LocationNode")
...
SWIFT_CLASS("_TtC4ARCL22LocationAnnotationNode")
...
SWIFT_CLASS("_TtC4ARCL15LocationManager")
...
@interface SceneLocationView : ARSCNView <ARSCNViewDelegate>
